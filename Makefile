...
#    Updated: 2024/07/23 23:45:30 by ylai             ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_print_str ft_print_uint
UTIL_FILES := ft_abs ft_find_len ft_isnegative ft_itoa ft_itohex ft_ltoa \
ft_putchar ft_putstr ft_strlcpy ft_strlen
SRCS := $(addprefix $(UTIL_DIR), $(addsuffix .c, $(UTIL_FILES))) \
$(addprefix $(MAIN_DIR), $(addsuffix .c, $(MAIN_FILES))) ft_printf.c
OBJS := ${SRCS:.c=.o}
